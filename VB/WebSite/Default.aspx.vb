...
Partial Public Class _Default
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
		...
		Labeller.AddLabels(Me.ASPxScheduler1.Storage)
		Statusser.AddStatuses(Me.ASPxScheduler1.Storage)
	...
	Protected Sub ASPxScheduler1_BeforeExecuteCallbackCommand(ByVal sender As Object, ByVal e As SchedulerCallbackCommandEventArgs)
		...
		End If
	End Sub
	Protected Sub ASPxScheduler1_InitNewAppointment(ByVal sender As Object, ByVal e As AppointmentEventArgs)
