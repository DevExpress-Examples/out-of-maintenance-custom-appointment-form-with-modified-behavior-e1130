...
<body>
	...
	<div>
		...
		OnAppointmentFormShowing="ASPxScheduler1_AppointmentFormShowing" GroupType="Resource" Start="2008-12-16" ClientInstanceName="scheduler" OnAppointmentInserting="ASPxScheduler1_AppointmentInserting" OnBeforeExecuteCallbackCommand="ASPxScheduler1_BeforeExecuteCallbackCommand" OnInitNewAppointment="ASPxScheduler1_InitNewAppointment">
		<Storage>
			<Appointments>
			</Appointments>
		</Storage>            
